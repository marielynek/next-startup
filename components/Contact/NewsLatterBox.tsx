...
const NewsLatterBox = () => {
  ...
  return (
    ...
    >
      ...
      Stay informed and be the first to know. Subscribe for exclusive updates, valuable content, and the latest in web development delivered directly to your inbox.
      </p>
      <div>
        <input
          type="text"
